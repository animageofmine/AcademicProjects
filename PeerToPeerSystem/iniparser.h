...
/*--------------------------MY PROTOTYPES ADDED FROM HERE ONWARDS-------------*/
char * iniparser_beacon_nodes(dictionary *ini,char *ininame);
char ***init_neighbor_list(dictionary *ini,char *init_neighbor_filename);
